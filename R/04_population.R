...
#   06  each town's span -- chartered across three centuries,
...
p_life <- ggplot(life) +
  ...
  labs(title = "From charter to dissolution",
       subtitle = "Each town was chartered in a different era; all four were dissolved on the same day",
       x = NULL, y = NULL,
...
p_decline <- ggplot() +
  ...
  labs(title = "Four towns in decline, 1900-1920",
       subtitle = "All four were losing population for decades before the reservoir; all were dissolved by 1938",
       x = NULL, y = "Population",
       caption = paste0(
